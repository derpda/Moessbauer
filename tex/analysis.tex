...
\end{table}
For the error estimation the bigger difference (0.04) is chosen. As the peak width of the absorber, the width of the fitted Voigt profile is used, calculated with the empirical  approximation}($0.02\%$ accuracy)\cite{Olivero}:
\begin{equation}
